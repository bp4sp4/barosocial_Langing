    ...
    <div className={styles.container}>
      ...
      <div className={styles.heroSection}>
        ...
        <div className={styles.herosvg}>
          ...
          >
            <path
              d="M1.77075 3.50555C1.77075 3.85351 1.90931 4.18742 2.15527 4.43353L9.58038 11.8586C9.8265 12.1046 10.1604 12.2432 10.5084 12.2432C10.8562 12.243 11.1903 12.1046 11.4363 11.8586L18.8602 4.43353C19.0992 4.186 19.2323 3.85477 19.2293 3.51068C19.2263 3.16668 19.088 2.83753 18.8448 2.59424C18.6016 2.351 18.2723 2.21283 17.9283 2.20972C17.5842 2.20673 17.2517 2.33854 17.0042 2.57758L10.5084 9.07471L4.01123 2.57758C3.76518 2.33168 3.43111 2.19441 3.08325 2.19434C2.73543 2.19434 2.40136 2.33179 2.15527 2.57758C1.90935 2.82357 1.7709 3.15773 1.77075 3.50555Z"
              fill="#FF751F"
            />
            <path
              d="M1.77075 10.0681C1.77075 10.416 1.90931 10.7499 2.15527 10.996L9.58038 18.4211C9.8265 18.6671 10.1604 18.8057 10.5084 18.8057C10.8562 18.8055 11.1903 18.6671 11.4363 18.4211L18.8602 10.996C19.0992 10.7485 19.2323 10.4173 19.2293 10.0732C19.2263 9.72918 19.088 9.40003 18.8448 9.15674C18.6016 8.9135 18.2723 8.77533 17.9283 8.77222C17.5842 8.76923 17.2517 8.90104 17.0042 9.14008L10.5084 15.6372L4.01123 9.14008C3.76518 8.89418 3.43111 8.75691 3.08325 8.75684C2.73543 8.75684 2.40136 8.89429 2.15527 9.14008C1.90935 9.38607 1.7709 9.72023 1.77075 10.0681Z"
              fill="#FF751F"
            />
          </svg>
        </div>
      ...
      <div className={styles.section2}>
        ...
        <p className={styles.section2Desc}>
          사회복지에 관한 전문지식과 기술을 가진 사람으로서,
          <br /> 보건복지부 장관이 발급하는 사회복지사 자격증을 받은 사람을
          말한다.
          <br /> (출처: 네이버지식백과, 사회복지사)
        </p>
      </div>
      ...
      <div className={styles.section3}>
        <div className={styles.section3Title}>
          <p className={styles.section3TitleNormal}>
            똑똑한 주부님들이
            <br />
            <span className={styles.section3TitleUnderline}>
              사회복지사 2급을 선택
            </span>
            하는 이유
          </p>
        ...
        <div className={styles.section3Grid}>
          ...
          <div className={styles.section3Card}>
            ...
            <img
              ...
              loading="eager"
            />
            <p className={styles.section3CardText}>
              경력 없어도{"\n"}취업 가능
            </p>
          </div>
          <div className={styles.section3Card}>
      ...
      <div className={styles.section4}>
        <div className={styles.section4TitleWrap}>
          ...
          <div className={styles.section_contentwrap}>
            ...
            <p className={styles.section4TitleBold}>
              일자리 확대{" "}
              <span className={styles.section4TitleLightInline}>및</span>{" "}
              고용인원 증가
            </p>
          </div>
          <div className={styles.section4GraphWrap}>
            ...
            <img
              src="/graph_01.png"
              alt="그래프 1"
              className={styles.section4Graph}
              loading="eager"
            />
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/graph_02.png"
              alt="그래프 2"
              className={styles.section4Graph2}
              loading="eager"
            />
          </div>
        </div>
      ...
      <div className={styles.section5}>
        <div className={styles.section4TitleWrap}>
          ...
          <div className={styles.section_contentwrap}>
            ...
            <p className={styles.section4TitleBold}>
              다양한 기관으로 취업{" "}
              <span className={styles.section4TitleLightInline}>가능</span>
            </p>
          </div>
        </div>
        ...
        <div className={styles.placeExtra}>
          <p className={styles.placeExtraText}>
            그 외에도 가정폭력보호시설, 정신건강 증진시설, 성폭력피해보호시설,
            {"\n"}사회복지관, 한부모가족복지시설, 노숙인시설, 결핵 · 한센시설,
            건강가정지원센터,
            <br />
            다함께돌봄센터, 지역자활센터 등 다양한 기관이 있습니다.
          </p>
          <p className={styles.placeExtraSource}>
            출처: 2024년 사회복지시설 종사자 인건비 가이드라인 (보건복지부,
            2024)
          </p>
        </div>
      </div>
      ...
      {/* 메인 3섹션 */}
      <div className={styles.sectionMain3}>
        <span className={styles.section4Badge}>3</span>
        <div className={styles.sectionMain3TextWrap}>
          <p className={styles.sectionMain3TextLight}>사회복지사 자격증,</p>
          <p className={styles.sectionMain3TextLine}>
            <span className={styles.sectionMain3TextBold}>어떻게 취득</span>
            <span className={styles.sectionMain3TextLight}>하나요?</span>
          </p>
        </div>
        <div className={styles.main3CardList}>
          {/* <div className={styles.main3Card}>
            ...
            <div className={styles.main3CardBody}>
              <p className={styles.main3CardRow}>
                <span className={styles.main3CardBold}>고등학교</span>
                <span className={styles.main3CardMedium}>졸업자* 기준</span>
                <span className={styles.main3CardOrange}>16개월</span>
              </p>
              <p className={styles.main3CardRow}>
                <span className={styles.main3CardBold}>대학교</span>
                <span className={styles.main3CardMedium}>졸업자 기준</span>
                <span className={styles.main3CardOrange}>12개월</span>
              </p>
            </div>
            <div className={styles.main3CardNote}>
              <span className={styles.main3NoteNormal}>
                *고등학교 졸업자는 기간 단축하여 대학교 졸업자와{"\n"}
                동일하게{" "}
              </span>
          ...
          <div className={styles.main3Card}>
            ...
            <div className={styles.main3MethodRow}>
              <div className={styles.main3MethodItem}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/section3_01.png"
                  alt="온라인 수업"
                  className={styles.main3MethodImg}
                  loading="eager"
                />
                <div className={styles.main3MethodText}>
                  <span className={styles.main3MethodBold}>온라인으로</span>
                  <span className={styles.main3MethodNormal}>
                    수업을 수강한 후,
                  </span>
                </div>
              </div>
              <div className={styles.main3MethodArrow}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
              ...
              <div className={styles.main3MethodItem}>
                ...
                />
                <div className={styles.main3MethodText}>
                  <span className={styles.main3MethodBold}>실습기관에서</span>
                  <span className={styles.main3MethodNormal}>
                    실습을 진행합니다.
                  </span>
                </div>
          ...
          <div className={styles.main3Card}>
            <span className={styles.main3Badge}>자격증 취득</span>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/section3_03.png"
              alt="자격증 취득"
      ...
      <div className={styles.sectionFinal}>
        ...
        <button
          id="consult-btn"
          className={styles.sectionFinalBtn}
          onClick={() => setModalOpen(true)}
        >
          무료상담 신청하기
        </button>
        <p className={styles.sectionFinalNote}>
          * 수강신청은 개강반 정원에 따라 조기마감 될 수 있습니다.
        </p>
      </div>
