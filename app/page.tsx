    ...
    <div className={styles.container}>
      ...
      <div className={styles.heroSection}>
        ...
        <div className={styles.herosvg}>        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
          <path d="M1.77069 3.50555C1.77069 3.85351 1.90925 4.18742 2.15521 4.43353L9.58032 11.8586C9.82644 12.1046 10.1603 12.2432 10.5083 12.2432C10.8561 12.243 11.1903 12.1046 11.4363 11.8586L18.8601 4.43353C19.0991 4.186 19.2322 3.85477 19.2292 3.51068C19.2262 3.16668 19.0879 2.83753 18.8447 2.59424C18.6015 2.351 18.2722 2.21283 17.9283 2.20972C17.5842 2.20673 17.2517 2.33854 17.0042 2.57758L10.5083 9.07471L4.01117 2.57758C3.76512 2.33168 3.43105 2.19441 3.08319 2.19434C2.73536 2.19434 2.4013 2.33179 2.15521 2.57758C1.90929 2.82357 1.77084 3.15773 1.77069 3.50555Z" fill="#7FA8FF"/>
          <path d="M1.77069 10.0681C1.77069 10.416 1.90925 10.7499 2.15521 10.996L9.58032 18.4211C9.82644 18.6671 10.1603 18.8057 10.5083 18.8057C10.8561 18.8055 11.1903 18.6671 11.4363 18.4211L18.8601 10.996C19.0991 10.7485 19.2322 10.4173 19.2292 10.0732C19.2262 9.72918 19.0879 9.40003 18.8447 9.15674C18.6015 8.9135 18.2722 8.77533 17.9283 8.77222C17.5842 8.76923 17.2517 8.90104 17.0042 9.14008L10.5083 15.6372L4.01117 9.14008C3.76512 8.89418 3.43105 8.75691 3.08319 8.75684C2.73536 8.75684 2.4013 8.89429 2.15521 9.14008C1.90929 9.38607 1.77084 9.72023 1.77069 10.0681Z" fill="#7FA8FF"/>
        </svg>
        </div>
